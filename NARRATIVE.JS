...
export const storyTemplates = {
    initiation: [
        "The {LocationName}, a treacherous expanse of {LocationTerrain}, became the stage for a clash of titans. <span class='char-{Fighter1ID}'>{Fighter1Name}</span>, {Fighter1Desc}, and <span class='char-{Fighter2ID}'>{Fighter2Name}</span>, {Fighter2Desc}, locked eyes, the air thick with anticipation as {LocationFeature} loomed. {Fighter1IntroQuote} {Fighter2IntroQuote}",
        "Under the watchful gaze of {LocationName}'s {LocationFeature}, a legendary battle was about to unfold. <span class='char-{Fighter1ID}'>{Fighter1Name}</span>, {Fighter1Desc}, stepped onto the {LocationTerrain}, their resolve mirrored by <span class='char-{Fighter2ID}'>{Fighter2Name}</span>, {Fighter2Desc}'s unwavering stance. {Fighter1IntroQuote} {Fighter2IntroQuote}",
        "On the {LocationTerrain} of the {LocationName}, the ground trembled faintly as <span class='char-{Fighter1ID}'>{Fighter1Name}</span>, {Fighter1Desc}, and <span class='char-{Fighter2ID}'>{Fighter2Name}</span>, {Fighter2Desc}, prepared for an epic confrontation. The very elements seemed to hold their breath. {Fighter1IntroQuote} {Fighter2IntroQuote}",
        "The {LocationName} offered no quarter, its {LocationTerrain} awaiting the chaos. <span class='char-{Fighter1ID}'>{Fighter1Name}</span>, {Fighter1Desc}, faced <span class='char-{Fighter2ID}'>{Fighter2Name}</span>, {Fighter2Desc}, in a duel that would shake the very foundations of the realm. {Fighter1IntroQuote} {Fighter2IntroQuote}"
    ],
    initiation_relationship: {
        'aang-airbending-only_katara': [
            "Sibling rivalry, a fierce clash of elements and wills, was about to unfold on the {LocationTerrain} of the {LocationName}. <span class='char-aang-airbending-only'>Aang</span> and <span class='char-katara'>Katara</span>, friends and family, faced each other, their bond challenged by the arena's call. \"{Fighter1IntroQuote}\" \"{Fighter2IntroQuote}\"",
            "Under the gaze of {LocationName}'s {LocationFeature}, <span class='char-aang-airbending-only'>Aang</span> and <span class='char-katara'>Katara</span>, companions through countless journeys, now stood as opponents. Their mutual respect was palpable, but the challenge hung heavy in the air. \"{Fighter1IntroQuote}\" \"{Fighter2IntroQuote}\""
        ],
        'zuko_azula': [
            "Animosity and a shared, tortured past crackled in the air above the {LocationTerrain} of the {LocationName}. <span class='char-zuko'>Zuko</span> and <span class='char-azula'>Azula</span>, siblings torn by ambition, prepared for a bitter clash beneath {LocationFeature}. \"{Fighter1IntroQuote}\" \"{Fighter2IntroQuote}\"",
            "The tension was thicker than the air in the {LocationName} as <span class='char-zuko'>Zuko</span> and <span class='char-azula'>Azula</span>, two sides of a fractured family, locked eyes. Their long-standing rivalry was about to ignite. \"{Fighter1IntroQuote}\" \"{Fighter2IntroQuote}\""
        ],
        'iroh_zuko': [
            "A poignant silence fell over the {LocationName}'s {LocationTerrain} as <span class='char-iroh'>Iroh</span> and <span class='char-zuko'>Zuko</span>, uncle and nephew, prepared for an inescapable confrontation. The weight of their shared history hung heavy in the air, intensified by {LocationFeature}. \"{Fighter1IntroQuote}\" \"{Fighter2IntroQuote}\"",
            "This battle on the {LocationTerrain} of the {LocationName} was more than just a fight; it was a testament to a complex bond. <span class='char-iroh'>Iroh</span> faced his nephew, <span class='char-zuko'>Zuko</span>, in a duel laden with unspoken emotion. \"{Fighter1IntroQuote}\" \"{Fighter2IntroQuote}\""
        ],
    },
};