...
import { availableCharacters, getCharacterById } from '../../../character-selection/data/characterData';
...
const azula: BattleCharacter = { ...aang, name: "Azula", id: "p2", base: getCharacterById('azula')! };
...
describe('UnifiedBattleLog – log actor contract', () => {
  it('never passes fighter names as actor on non-dialogue logs', () => {
    ...
    const { logEntry } = forcePatternEscalation(state, aang);
    logs.push(logEntry);
