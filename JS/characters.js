...
export const characters = {
    'sokka': {
        ...
        techniques: [
            ...
            { name: "Improvised Trap", verb: 'devise', object: 'clever trap', type: 'Utility', power: 50, emoji: '🪤', requiresArticle: true },
            { name: "Sokka Style", verb: 'attempt', object: 'tactical feint', type: 'Offense', power: 25, emoji: '🧠', requiresArticle: true },
            { name: "The Sokka Special", verb: 'spring', object: 'masterfully constructed snare trap', type: 'Finisher', power: 75, emoji: '🏆', requiresArticle: true }
        ],
    ...
    'aang-airbending-only': {
        ...
        techniques: [
            ...
            { name: "Air Blast", verb: 'unleash', object: 'focused blast of air', type: 'Offense', power: 40, emoji: '💨', requiresArticle: true },
            { name: "Wind Shield", verb: 'form', object: 'swirling shield of wind', type: 'Defense', power: 50, emoji: '🛡️', requiresArticle: true },
            { name: "Tornado Whirl", verb: 'create', object: 'disorienting tornado', type: 'Offense', power: 65, emoji: '🌪️', requiresArticle: true },
            { name: "Air Cushion", verb: 'create', object: 'cushion of air', type: 'Utility', power: 25, emoji: '☁️', requiresArticle: true },
    ...
    'katara': {
        ...
        techniques: [
            ...
            { name: "Ice Spears", verb: 'launch', object: 'volley of ice spears', type: 'Offense', power: 55, emoji: '🧊', requiresArticle: true },
            { name: "Water Shield", verb: 'raise', object: 'shield of water', type: 'Defense', power: 50, emoji: '🛡️', requiresArticle: true },
            { name: "Healing Waters", verb: 'use', object: 'healing waters', type: 'Utility', power: 30, emoji: '🩹', requiresArticle: false },
            { name: "Ice Prison", verb: 'create', object: 'ice prison', type: 'Utility', power: 60, emoji: '🧊', requiresArticle: true },
            { name: "Tidal Wave", verb: 'summon', object: 'massive tidal wave', type: 'Finisher', power: 90, emoji: '🌊', requiresArticle: true },
    ...
    'toph-beifong': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Earth Wave", verb: 'send', object: 'powerful wave of earth', type: 'Offense', power: 60, emoji: '🌊', requiresArticle: true },
            { name: "Rock Armor", verb: 'don', object: 'suit of rock armor', type: 'Defense', power: 75, emoji: '🗿', requiresArticle: true },
            ...
            { name: "Boulder Throw", verb: 'launch', object: 'volley of rock projectiles', type: 'Offense', power: 65, emoji: '🪨', requiresArticle: false },
    ...
    'zuko': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Fire Daggers", verb: 'throw', object: 'volley of fire daggers', type: 'Offense', power: 45, emoji: '🔪', requiresArticle: true },
            { name: "Flame Sword", verb: 'ignite', object: 'his dual dao swords', type: 'Offense', power: 55, emoji: '⚔️', requiresArticle: false },
            { name: "Fire Shield", verb: 'create', object: 'swirling fire shield', type: 'Defense', power: 50, emoji: '🛡️', requiresArticle: true },
            { name: "Dragon's Breath", verb: 'unleash', object: 'sustained stream of fire', type: 'Offense', power: 70, emoji: '🐉', requiresArticle: false },
    ...
    'azula': {
        ...
        techniques: [
            ...
            { name: "Lightning Generation", verb: 'generate', object: 'precise bolt of lightning', type: 'Finisher', power: 100, emoji: '⚡', requiresArticle: true },
            ...
            { name: "Heat Wave", verb: 'release', object: 'debilitating heat wave', type: 'Utility', power: 35, emoji: '☀️', requiresArticle: true },
            { name: "Fire Shield", verb: 'create', object: 'shield of rotating fire', type: 'Defense', power: 60, emoji: '🛡️', requiresArticle: true }
        ],
    ...
    'ozai-not-comet-enhanced': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Fire Comet", verb: 'launch', object: 'massive fire comet', type: 'Offense', power: 80, emoji: '☄️', requiresArticle: true },
            { name: "Flame Tornado", verb: 'create', object: 'searing flame tornado', type: 'Offense', power: 75, emoji: '🌪️', requiresArticle: true },
            { name: "Royal Fire", verb: 'unleash', object: 'blast of royal fire', type: 'Offense', power: 65, emoji: '👑', requiresArticle: true },
            { name: "Fire Armor", verb: 'ignite', object: 'suit of fire armor', type: 'Defense', power: 60, emoji: '🛡️', requiresArticle: true },
            { name: "Dragon's Roar", verb: 'breathe', object: 'devastating cone of fire', type: 'Offense', power: 85, emoji: '🐉', requiresArticle: true },
    ...
    'bumi': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Rock Avalanche", verb: 'trigger', object: 'massive rock avalanche', type: 'Finisher', power: 95, emoji: '🌋', requiresArticle: true },
            { name: "Earth Armor", verb: 'don', object: 'suit of earth armor', type: 'Defense', power: 70, emoji: '🗿', requiresArticle: true },
            { name: "Seismic Scan", verb: 'scan', object: 'the battlefield with seismic sense', type: 'Utility', power: 15, emoji: '📡', requiresArticle: false },
            { name: "Boulder Throw", verb: 'hurl', object: 'giant boulder', type: 'Offense', power: 60, emoji: '🪨', requiresArticle: true },
            { name: "Ground Spike", verb: 'erupt', object: 'spike of rock from the ground', type: 'Offense', power: 45, emoji: '⛰️', requiresArticle: true },
    ...
    'ty-lee': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Acrobatic Flips", verb: 'execute', object: 'series of acrobatic flips', type: 'Utility', power: 25, emoji: '🤸‍♀️', requiresArticle: true },
            { name: "Pressure Point Strike", verb: 'strike', object: 'vital pressure point', type: 'Offense', power: 60, emoji: '🎯', requiresArticle: true },
            { name: "Graceful Dodge", verb: 'gracefully dodge', object: 'incoming attack', type: 'Defense', power: 40, emoji: '🍃', requiresArticle: true },
            { name: "Blur of Motion", verb: 'move', object: 'like a blur', type: 'Utility', power: 20, emoji: '💨', requiresArticle: false },
            { name: "Chi-Blocking Flurry", verb: 'deliver', object: 'flurry of chi-blocking strikes', type: 'Finisher', power: 85, emoji: '🛑', requiresArticle: true }
        ],
    ...
    'mai': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Knife Barrage", verb: 'unleash', object: 'barrage of knives', type: 'Offense', power: 50, emoji: '🔪', requiresArticle: true },
            { name: "Precision Strike", verb: 'throw', object: 'single, perfectly aimed knife', type: 'Offense', power: 65, emoji: '🎯', requiresArticle: true },
            { name: "Knife Wall", verb: 'create', object: 'defensive wall of knives', type: 'Defense', power: 45, emoji: '🧱', requiresArticle: true },
            ...
            { name: "Ricochet Shot", verb: 'launch', object: 'ricochet shot', type: 'Offense', power: 55, emoji: '🔄', requiresArticle: true },
            { name: "Final Pin", verb: 'unleash', object: 'final volley to trap her opponent', type: 'Finisher', power: 80, emoji: '📍', requiresArticle: false }
        ],
    ...
    'iroh': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Fire Breath", verb: 'breathe', object: 'plume of controlled fire', type: 'Offense', power: 60, emoji: '🐉', requiresArticle: true },
            { name: "Lightning Generation", verb: 'generate', object: 'powerful bolt of lightning', type: 'Finisher', power: 95, emoji: '⚡', requiresArticle: true },
            { name: "Lightning Redirection", verb: 'redirect', object: 'incoming lightning attack', type: 'Defense', power: 80, emoji: '🔄', requiresArticle: true },
            { name: "Flame Barrier", verb: 'create', object: 'wall of fire', type: 'Defense', power: 65, emoji: '🧱', requiresArticle: true },
            ...
            { name: "Warming Embrace", verb: 'offer', object: 'warming embrace', type: 'Utility', power: 20, emoji: '☕', requiresArticle: true },
    ...
    'pakku': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Ice Spikes", verb: 'launch', object: 'volley of ice spikes', type: 'Offense', power: 50, emoji: '🧊', requiresArticle: true },
            { name: "Water Barrier", verb: 'erect', object: 'solid water barrier', type: 'Defense', power: 60, emoji: '🛡️', requiresArticle: true },
            ...
            { name: "Tidal Surge", verb: 'summon', object: 'powerful tidal surge', type: 'Offense', power: 75, emoji: '🌊', requiresArticle: true },
            { name: "Ice Armor", verb: 'form', object: 'suit of ice armor', type: 'Defense', power: 70, emoji: '🗿', requiresArticle: true },
    ...
    'jeong-jeong': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Controlled Inferno", verb: 'create', object: 'controlled inferno', type: 'Offense', power: 80, emoji: '🔥', requiresArticle: true },
            { name: "Fire Wall", verb: 'raise', object: 'impenetrable wall of fire', type: 'Defense', power: 85, emoji: '🧱', requiresArticle: true },
            { name: "Flame Whips", verb: 'conjure', object: 'precise flame whips', type: 'Offense', power: 55, emoji: '🐍', requiresArticle: false },
            { name: "Fire Cloak", verb: 'don', object: 'cloak of defensive fire', type: 'Defense', power: 50, emoji: '🧥', requiresArticle: true },
            { name: "Precision Burn", verb: 'inflict', object: 'surgical burn', type: 'Offense', power: 45, emoji: '🎯', requiresArticle: true },
            { name: "Flame Dispersion", verb: 'disperse', object: 'incoming fire attack', type: 'Defense', power: 60, emoji: '💨', requiresArticle: true },
