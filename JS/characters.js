...
export const characters = {
    'sokka': {
        ...
        techniques: [
            { name: "Sword Strike", verb: 'strike', object: 'with his meteorite sword', type: 'Offense', power: 40, emoji: '⚔️', requiresArticle: false, element: 'physical' },
            { name: "Boomerang Throw", verb: 'throw', object: 'his trusty boomerang', type: 'Offense', power: 35, emoji: '🪃', requiresArticle: false, element: 'physical' },
            { name: "Shield Block", verb: 'block', object: 'with his shield', type: 'Defense', power: 30, emoji: '🛡️', requiresArticle: false, element: 'utility' },
            { name: "Tactical Positioning", verb: 'reposition', object: 'for a tactical advantage', type: 'Utility', power: 20, emoji: '🗺️', requiresArticle: false, element: 'utility' },
            { name: "Improvised Trap", verb: 'devise', object: 'clever trap', type: 'Utility', power: 50, emoji: '🪤', requiresArticle: true, element: 'utility' },
            { name: "Sokka Style", verb: 'attempt', object: 'tactical feint', type: 'Offense', power: 25, emoji: '🧠', requiresArticle: true, element: 'utility' },
            { name: "The Sokka Special", verb: 'spring', object: 'masterfully constructed snare trap', type: 'Finisher', power: 75, emoji: '🏆', requiresArticle: true, element: 'utility' }
        ],
    ...
    'aang-airbending-only': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Air Scooter", verb: 'ride', object: 'his air scooter', type: 'Utility', power: 20, emoji: '🛴', requiresArticle: false, element: 'air' },
            { name: "Air Blast", verb: 'unleash', object: 'focused blast of air', type: 'Offense', power: 40, emoji: '💨', requiresArticle: true, element: 'air' },
            { name: "Wind Shield", verb: 'form', object: 'swirling shield of wind', type: 'Defense', power: 50, emoji: '🛡️', requiresArticle: true, element: 'air' },
            { name: "Tornado Whirl", verb: 'create', object: 'disorienting tornado', type: 'Offense', power: 65, emoji: '🌪️', requiresArticle: true, element: 'air' },
            { name: "Air Cushion", verb: 'create', object: 'cushion of air', type: 'Utility', power: 25, emoji: '☁️', requiresArticle: true, element: 'air' },
            { name: "Gust Push", verb: 'push', object: 'with a sudden gust of wind', type: 'Offense', power: 30, emoji: '🌬️', requiresArticle: false, element: 'air' },
            { name: "Sweeping Gust", verb: 'sweep', object: 'his foe off their feet', type: 'Finisher', power: 80, emoji: '🧹', requiresArticle: false, element: 'air' }
        ],
    ...
    'katara': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Water Whip", verb: 'lash', object: 'out with a water whip', type: 'Offense', power: 45, emoji: '💧', requiresArticle: false, element: 'water' },
            { name: "Ice Spears", verb: 'launch', object: 'volley of ice spears', type: 'Offense', power: 55, emoji: '🧊', requiresArticle: true, element: 'ice' },
            { name: "Water Shield", verb: 'raise', object: 'shield of water', type: 'Defense', power: 50, emoji: '🛡️', requiresArticle: true, element: 'water' },
            { name: "Healing Waters", verb: 'use', object: 'healing waters', type: 'Utility', power: 30, emoji: '🩹', requiresArticle: false, element: 'healing' },
            { name: "Ice Prison", verb: 'create', object: 'ice prison', type: 'Utility', power: 60, emoji: '🧊', requiresArticle: true, element: 'ice' },
            { name: "Tidal Wave", verb: 'summon', object: 'massive tidal wave', type: 'Finisher', power: 90, emoji: '🌊', requiresArticle: true, element: 'water' },
            { name: "Bloodbending", verb: 'control', object: "her opponent's body", type: 'Finisher', power: 100, emoji: '🩸', requiresArticle: false, element: 'special' }
        ],
    ...
    'toph-beifong': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Earth Wave", verb: 'send', object: 'powerful wave of earth', type: 'Offense', power: 60, emoji: '🌊', requiresArticle: true, element: 'earth' },
            { name: "Rock Armor", verb: 'don', object: 'suit of rock armor', type: 'Defense', power: 75, emoji: '🗿', requiresArticle: true, element: 'earth' },
            { name: "Seismic Slam", verb: 'slam', object: 'her fists to the ground', type: 'Offense', power: 70, emoji: '💥', requiresArticle: false, element: 'earth' },
            { name: "Metal Bending", verb: 'bend', object: 'the metal in the environment', type: 'Offense', power: 80, emoji: '🔩', requiresArticle: false, element: 'metal' },
            { name: "Earth Tunnel", verb: 'tunnel', object: 'underground to reposition', type: 'Utility', power: 30, emoji: '🚇', requiresArticle: false, element: 'earth' },
            { name: "Boulder Throw", verb: 'launch', object: 'volley of rock projectiles', type: 'Offense', power: 65, emoji: '🪨', requiresArticle: false, element: 'earth' },
            { name: "Quicksand Trap", verb: 'turn', object: 'the ground to quicksand', type: 'Utility', power: 55, emoji: '⏳', requiresArticle: false, element: 'sand' },
            { name: "Rock Coffin", verb: 'entomb', object: 'her foe in a prison of rock', type: 'Finisher', power: 95, emoji: '⚰️', requiresArticle: false, element: 'earth' }
        ],
    ...
    'zuko': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Fire Daggers", verb: 'throw', object: 'volley of fire daggers', type: 'Offense', power: 45, emoji: '🔪', requiresArticle: true, element: 'fire' },
            { name: "Flame Sword", verb: 'ignite', object: 'his dual dao swords', type: 'Offense', power: 55, emoji: '⚔️', requiresArticle: false, element: 'fire' },
            { name: "Fire Shield", verb: 'create', object: 'swirling fire shield', type: 'Defense', power: 50, emoji: '🛡️', requiresArticle: true, element: 'fire' },
            { name: "Dragon's Breath", verb: 'unleash', object: 'sustained stream of fire', type: 'Offense', power: 70, emoji: '🐉', requiresArticle: false, element: 'fire' },
            { name: "Agni Kai Stance", verb: 'assume', object: 'the Agni Kai stance', type: 'Utility', power: 30, emoji: '🤺', requiresArticle: false, element: 'utility' },
            { name: "Fire Whip", verb: 'lash', object: 'out with a whip of fire', type: 'Offense', power: 60, emoji: '🔥', requiresArticle: false, element: 'fire' },
            { name: "Blazing Charge", verb: 'charge', object: 'forward, propelled by fire', type: 'Offense', power: 65, emoji: '🚀', requiresArticle: false, element: 'fire' },
            { name: "Redemption's Fury", verb: 'overwhelm', object: 'his opponent with a flurry of attacks', type: 'Finisher', power: 85, emoji: '🔥', requiresArticle: false, element: 'fire' }
        ],
    ...
    'azula': {
        ...
        techniques: [
            ...
            { name: "Fire Shield", verb: 'create', object: 'shield of rotating fire', type: 'Defense', power: 60, emoji: '🛡️', requiresArticle: true, element: 'fire' }
        ],
    ...
    'ozai-not-comet-enhanced': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Fire Comet", verb: 'launch', object: 'massive fire comet', type: 'Offense', power: 80, emoji: '☄️', requiresArticle: true, element: 'fire' },
            { name: "Flame Tornado", verb: 'create', object: 'searing flame tornado', type: 'Offense', power: 75, emoji: '🌪️', requiresArticle: true, element: 'fire' },
            { name: "Royal Fire", verb: 'unleash', object: 'blast of royal fire', type: 'Offense', power: 65, emoji: '👑', requiresArticle: true, element: 'fire' },
            { name: "Fire Armor", verb: 'ignite', object: 'suit of fire armor', type: 'Defense', power: 60, emoji: '🛡️', requiresArticle: true, element: 'fire' },
            { name: "Dragon's Roar", verb: 'breathe', object: 'devastating cone of fire', type: 'Offense', power: 85, emoji: '🐉', requiresArticle: true, element: 'fire' },
            { name: "Phoenix Strike", verb: 'dive', object: 'with a phoenix strike', type: 'Offense', power: 70, emoji: '🐦', requiresArticle: false, element: 'fire' },
            { name: "Inferno Field", verb: 'set', object: 'the battlefield ablaze', type: 'Utility', power: 50, emoji: '🌍', requiresArticle: false, element: 'fire' },
            { name: "Emperor's Wrath", verb: 'unleash', object: "the Emperor's Wrath", type: 'Finisher', power: 100, emoji: '😠', requiresArticle: false, element: 'fire' }
        ],
    ...
    'bumi': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Rock Avalanche", verb: 'trigger', object: 'massive rock avalanche', type: 'Finisher', power: 95, emoji: '🌋', requiresArticle: true, element: 'earth' },
    ...
    'mai': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Knife Barrage", verb: 'unleash', object: 'barrage of knives', type: 'Offense', power: 50, emoji: '🔪', requiresArticle: true, element: 'physical' },
    ...
    'iroh': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Fire Breath", verb: 'breathe', object: 'plume of controlled fire', type: 'Offense', power: 60, emoji: '🐉', requiresArticle: true, element: 'fire' },
            { name: "Lightning Generation", verb: 'generate', object: 'powerful bolt of lightning', type: 'Finisher', power: 95, emoji: '⚡', requiresArticle: true, element: 'lightning' },
            { name: "Lightning Redirection", verb: 'redirect', object: 'incoming lightning attack', type: 'Defense', power: 80, emoji: '🔄', requiresArticle: true, element: 'lightning' },
            { name: "Flame Barrier", verb: 'create', object: 'wall of fire', type: 'Defense', power: 65, emoji: '🧱', requiresArticle: true, element: 'fire' },
            { name: "Dragon Dance", verb: 'perform', object: 'the Dragon Dance', type: 'Utility', power: 25, emoji: '💃', requiresArticle: false, element: 'utility' },
            { name: "Spiritual Fire", verb: 'unleash', object: 'spiritual fire', type: 'Offense', power: 70, emoji: '🧘', requiresArticle: false, element: 'special' },
            { name: "Warming Embrace", verb: 'offer', object: 'warming embrace', type: 'Utility', power: 20, emoji: '☕', requiresArticle: true, element: 'healing' },
            { name: "Wise Strike", verb: 'strike', object: 'with a precise blast of fire', type: 'Offense', power: 50, emoji: '🍵', requiresArticle: false, element: 'fire' }
        ],
    ...
    'jeong-jeong': {
        ...
        maxHealth: 100, maxEnergy: 100,
        techniques: [
            { name: "Controlled Inferno", verb: 'create', object: 'controlled inferno', type: 'Offense', power: 80, emoji: '🔥', requiresArticle: true, element: 'fire' },
            { name: "Fire Wall", verb: 'raise', object: 'impenetrable wall of fire', type: 'Defense', power: 85, emoji: '🧱', requiresArticle: true, element: 'fire' },
            { name: "Flame Whips", verb: 'conjure', object: 'precise flame whips', type: 'Offense', power: 55, emoji: '🐍', requiresArticle: false, element: 'fire' },
            { name: "Fire Cloak", verb: 'don', object: 'cloak of defensive fire', type: 'Defense', power: 50, emoji: '🧥', requiresArticle: true, element: 'fire' },
            { name: "Precision Burn", verb: 'inflict', object: 'surgical burn', type: 'Offense', power: 45, emoji: '🎯', requiresArticle: true, element: 'fire' },
            { name: "Flame Dispersion", verb: 'disperse', object: 'incoming fire attack', type: 'Defense', power: 60, emoji: '💨', requiresArticle: true, element: 'fire' },
            { name: "Reluctant Finale", verb: 'end', object: 'the fight with a wall of flame', type: 'Finisher', power: 90, emoji: '🛑', requiresArticle: false, element: 'fire' }
        ],
