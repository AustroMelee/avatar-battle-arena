...
export const characters = {
    'sokka': {
        ...
        techniques: [
            ...
            { name: "Improvised Trap", verb: 'devise', object: 'a clever trap', type: 'Utility', power: 50, requiresArticle: true, element: 'utility', moveTags: [] },
            { name: "The Sokka Special", verb: 'spring', object: 'a masterfully constructed snare trap', type: 'Finisher', power: 75, requiresArticle: true, element: 'utility', moveTags: [] }
        ],
    ...
    'aang-airbending-only': {
        ...
        techniques: [
            ...
            { name: "Air Blast", verb: 'unleash', object: 'a focused blast of air', type: 'Offense', power: 40, requiresArticle: true, element: 'air', moveTags: ['collateral_damage_low'] },
            { name: "Wind Shield", verb: 'form', object: 'a swirling shield of wind', type: 'Defense', power: 50, requiresArticle: true, element: 'air', moveTags: [] },
            { name: "Tornado Whirl", verb: 'create', object: 'a disorienting tornado', type: 'Offense', power: 65, requiresArticle: true, element: 'air', moveTags: ['collateral_damage_high'] },
    ...
    'katara': {
        ...
        techniques: [
            ...
            { name: "Ice Spears", verb: 'launch', object: 'a volley of ice spears', type: 'Offense', power: 55, requiresArticle: true, element: 'ice', moveTags: ['collateral_damage_medium'] },
            { name: "Water Shield", verb: 'raise', object: 'a shield of water', type: 'Defense', power: 50, requiresArticle: true, element: 'water', moveTags: [] },
            { name: "Ice Prison", verb: 'create', object: 'an ice prison', type: 'Utility', power: 60, requiresArticle: true, element: 'ice', moveTags: ['collateral_damage_medium'] },
            { name: "Tidal Wave", verb: 'summon', object: 'a massive tidal wave', type: 'Finisher', power: 90, requiresArticle: true, element: 'water', moveTags: ['collateral_damage_high'] },
    ...
    'toph-beifong': {
        ...
        techniques: [
            { name: "Earth Wave", verb: 'send', object: 'a powerful wave of earth', type: 'Offense', power: 60, requiresArticle: true, element: 'earth', moveTags: ['collateral_damage_high'] },
            { name: "Rock Armor", verb: 'don', object: 'a suit of rock armor', type: 'Defense', power: 75, requiresArticle: true, element: 'earth', moveTags: [] },
            ...
            { name: "Boulder Throw", verb: 'launch', object: 'a volley of rock projectiles', type: 'Offense', power: 65, element: 'earth', moveTags: ['collateral_damage_high'] },
    ...
    'zuko': {
        ...
        techniques: [
            { name: "Fire Daggers", verb: 'throw', object: 'a volley of fire daggers', type: 'Offense', power: 45, requiresArticle: true, element: 'fire', moveTags: ['collateral_damage_low'] },
            { name: "Flame Sword", verb: 'ignite', object: 'his dual dao swords', type: 'Offense', power: 55, element: 'fire', moveTags: ['precise'] },
            { name: "Fire Shield", verb: 'create', object: 'a swirling fire shield', type: 'Defense', power: 50, requiresArticle: true, element: 'fire', moveTags: [] },
            { name: "Dragon's Breath", verb: 'unleash', object: 'a sustained stream of fire', type: 'Offense', power: 70, element: 'fire', moveTags: ['collateral_damage_medium'] },
    ...
    'azula': {
        ...
        techniques: [
            ...
            { name: "Lightning Generation", verb: 'generate', object: 'a precise bolt of lightning', type: 'Finisher', power: 100, requiresArticle: true, element: 'lightning', moveTags: ['collateral_damage_high'] },
            { name: "Flame Burst", verb: 'erupt with', object: 'a burst of blue flame', type: 'Defense', power: 50, requiresArticle: true, element: 'fire', moveTags: ['collateral_damage_medium'] },
    ...
    'ozai-not-comet-enhanced': {
        ...
        techniques: [
            { name: "Fire Comet", verb: 'launch', object: 'a massive fire comet', type: 'Offense', power: 80, requiresArticle: true, element: 'fire', moveTags: ['collateral_damage_high'] },
            { name: "Flame Tornado", verb: 'create', object: 'a searing flame tornado', type: 'Offense', power: 75, requiresArticle: true, element: 'fire', moveTags: ['collateral_damage_high'] },
            { name: "Dragon's Roar", verb: 'breathe', object: 'a devastating cone of fire', type: 'Offense', power: 85, requiresArticle: true, element: 'fire', moveTags: ['collateral_damage_high'] },
    ...
    'bumi': {
        ...
        techniques: [
            { name: "Rock Avalanche", verb: 'trigger', object: 'a massive rock avalanche', type: 'Finisher', power: 95, requiresArticle: true, element: 'earth', moveTags: ['collateral_damage_high'] },
            { name: "Boulder Throw", verb: 'hurl', object: 'a giant boulder', type: 'Offense', power: 60, requiresArticle: true, element: 'earth', moveTags: ['collateral_damage_high'] },
            { name: "Ground Spike", verb: 'erupt with', object: 'a spike of rock from the ground', type: 'Offense', power: 45, requiresArticle: true, element: 'earth', moveTags: ['collateral_damage_low'] },
    ...
    'pakku': {
        ...
        techniques: [
            { name: "Ice Spikes", verb: 'launch', object: 'a volley of ice spikes', type: 'Offense', power: 50, requiresArticle: true, element: 'ice', moveTags: ['collateral_damage_medium'] },
            { name: "Water Barrier", verb: 'erect', object: 'a solid water barrier', type: 'Defense', power: 60, requiresArticle: true, element: 'water', moveTags: [] },
            { name: "Tidal Surge", verb: 'summon', object: 'a powerful tidal surge', type: 'Offense', power: 75, requiresArticle: true, element: 'water', moveTags: ['collateral_damage_high'] },
